...
// const hondaCars = getCarHonda(inventory);
// if (Array.isArray(hondaCars)) {
//   hondaCars.forEach(car => console.log(car));
// } else {
...
// The sorting is done using a compare function, which is passed as an argument to the sort() method.
// The compare function (a, b) => a.car_year - b.car_year subtracts the car_year property of 
// object a from the car_year property of object b. The result of this subtraction determines 
// the sorting order.

// If the result is a negative number, it means a.car_year is less than b.car_year, so a should 
// come before b in the sorted array.
// If the result is a positive number, it means a.car_year is greater than b.car_year, so a should 
// come after b in the sorted array.
// If the result is 0, it means a.car_year is equal to b.car_year, and their relative order doesn't 
// matter in the sorted array.